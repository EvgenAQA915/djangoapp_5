...
def update_item(request, my_id):
    ...
    context = {"item": item}
    return render(request, "djangoapp/updateitem.html", context)
...
def create_checkout_session(request, id):
    ...
    checkout_session = stripe.checkout.Session.create(
        ...
        mode="payment",
        success_url=request.build_absolute_uri(reverse("djangoapp:success"))
        + "?session_id={CHECKOUT_SESSION_ID}",
        cancel_url=request.build_absolute_uri(reverse("djangoapp:failed")),
    )
...
class PaymentSuccessView(TemplateView):
    template_name = "djangoapp/payment_success.html"
...
class PaymentFailedView(TemplateView):
    template_name = "djangoapp/payment_failed.html"